var prefix = contpath + "system/sysDept";
		...
		.bootstrapTreeTable(
			{
				...
				ajaxParams : {likeStr:$('#searchName').val()}, // 请求数据的ajax的data属性
...
// ADD START BY 李泽辉 20180402
function getTreeData() {
	$.ajax({
		type : "GET",
		// UPD START BY 李泽辉 20180403
		url : "../../system/sysDept/tree",
		/*url : prefix + '/tree',*/
		// UPD END BY 李泽辉 20180403
